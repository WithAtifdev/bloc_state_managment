...
bool operator ==(Object other) {
  final _this = this as MovieListModel;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MovieListModel&&(identical(other.total, _this.total) || other.total == _this.total)&&(identical(other.page, _this.page) || other.page == _this.page)&&(identical(other.pages, _this.pages) || other.pages == _this.pages)&&const DeepCollectionEquality().equals(other.tvShow, _this.tvShow));
}
...
int get hashCode {
  final _this = this as MovieListModel;
  return Object.hash(runtimeType,_this.total,_this.page,_this.pages,const DeepCollectionEquality().hash(_this.tvShow));
}

@override
String toString() {
  final _this = this as MovieListModel;
  return 'MovieListModel(total: ${_this.total}, page: ${_this.page}, pages: ${_this.pages}, tvShow: ${_this.tvShow})';
}
...
class _MovieListModel implements MovieListModel {
   _MovieListModel({this.total = 0, this.page = 0, this.pages = 0, @JsonKey(name: 'tv_shows')  List<TvShows> tvShow = const []}): _tvShow = tvShow;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _MovieListModel&&(identical(other.total, total) || other.total == total)&&(identical(other.page, page) || other.page == page)&&(identical(other.pages, pages) || other.pages == pages)&&const DeepCollectionEquality().equals(other.tvShow, _tvShow));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode {
    return Object.hash(runtimeType,total,page,pages,const DeepCollectionEquality().hash(_tvShow));
}
...
@JsonKey(name: 'name') String get name; String get permalink; String get endDate; String get network; String get imageThumbnailPath; String get status;
...
int get hashCode {
  final _this = this as TvShows;
  return Object.hash(runtimeType,_this.name,_this.permalink,_this.endDate,_this.network,_this.imageThumbnailPath,_this.status);
}

@override
String toString() {
  final _this = this as TvShows;
  return 'TvShows(name: ${_this.name}, permalink: ${_this.permalink}, endDate: ${_this.endDate}, network: ${_this.network}, imageThumbnailPath: ${_this.imageThumbnailPath}, status: ${_this.status})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,name,permalink,endDate,network,imageThumbnailPath,status);
}
