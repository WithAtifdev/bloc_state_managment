...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserModel&&(identical(other.token, _this.token) || other.token == _this.token)&&(identical(other.error, _this.error) || other.error == _this.error));
}
...
int get hashCode {
  final _this = this as UserModel;
  return Object.hash(runtimeType,_this.token,_this.error);
}

@override
String toString() {
  final _this = this as UserModel;
  return 'UserModel(token: ${_this.token}, error: ${_this.error})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,token,error);
}
